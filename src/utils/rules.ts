...
export const userSchema = yup.object({
  name: yup.string().default('').max(160, 'Độ dài tối đa là 160 ký tự'),
  phone: yup.string().default('').max(20, 'Độ dài tối đa là 20 ký tự'),
  ...
  day_of_birth: yup
    ...
    .max(new Date(), 'Vui lòng chọn một ngày trong quá khứ'),
